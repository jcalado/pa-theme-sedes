@if (is_admin())
    <img class="img-preview" src="{{ get_template_directory_uri() }}/Blocks/UPASDNtp/preview.png" alt="{{ __('Illustrative image of the front end of the block.', 'iasd') }}" />
@else 
	<div class="pa-widget pa-w-feliz7play py-4 col-12 position-relative bg-light mb-5">
		<div class="pa-slider-header mb-4">
			<div class="d-flex justify-content-between align-items-center">
				<img src="{{ get_template_directory_uri() }}/Blocks/UPASDNtp/assets/images/ntp.svg" alt="{{ __('Feliz7Play', 'iasd') }}" title="{{ __('Feliz7Play', 'iasd') }}" class="img-fluid">

				<a 
					href="https://www.novotempo.pt" 
					target="_blank"
