...
@else
    ...
    <div class="row py-5 px-3 px-xl-5">
      <div class="col-md-5 text-center text-md-start">
        ...
        <form class="pt-4 pt-xl-3 d-flex flex-column align-items-stretch" method="GET" target="_blank" action="https://jcalado.com/mapa_iasds">
          <div class="mb-3">
            <label for="find-church-input" class="form-label">{{ __('Church search', 'iasd') }}</label>
          
            <input id="find-church-input" name="search" type="search" class="form-control" placeholder="{{ __('Search by Postcode, city, neighborhood.', 'iasd') }}" required />
          </div>
